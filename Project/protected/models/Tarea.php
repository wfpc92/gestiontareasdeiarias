...
class Tarea extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('CORREO, NOMBRE_TAREA, PRIORIDAD', 'required'),
			...
			array('ID_FRECUENCIA, ID_ACTIVIDAD, PRIORIDAD, ESTADO, INAMOVIBLE, diaria', 'numerical', 'integerOnly'=>true),
			...
			array('ID_TAREA, ID_FRECUENCIA, CORREO, ID_ACTIVIDAD, NOMBRE_TAREA, FECHA_INICIO, FECHA_FIN, FECHA_ULTIMA_PAUSA, DURACION, PRIORIDAD, ESTADO, INAMOVIBLE, HORA_INICIO, HORA_FIN, diaria', 'safe', 'on'=>'search'),
		);
	}
